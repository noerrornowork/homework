  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogClosed">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="setRoleDialogVisible = false" size="mini">取 消</el-button>
          <el-button type="primary" @click="saveRoleInfo" size="mini">确 定</el-button>
        </span>
      </el-dialog>
    </el-card>
  </div>
...
export default {
  ...
  data () {
    ...
    var checkMobile = (rule, value, cb) => {
      ...
      return cb(new Error('请输入合法的手机号码'))
    }
    return {
      queryInfo: {
        query: '',
