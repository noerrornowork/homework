  ...
  <div>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addressVisible = false" size="mini"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    <el-dialog title="物流进度" :visible.sync="processVisible" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="processVisible = false" size="mini">取 消</el-button>
        <el-button type="primary" @click="processVisible = false" size="mini"
          >确 定</el-button
        >
      </span>
    </el-dialog>
